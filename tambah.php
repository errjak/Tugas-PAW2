                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="club" placeholder="Masukkan Club" required />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputNumber" class="col-sm-2 col-form-label">Gaji</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="gaji" placeholder="Masukkan Nama" required />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-10">
